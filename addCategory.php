<?php
    ...
    if(isset($_POST["title_category"]) && isset($_POST["content_category"])){

        $Database = new Database();
        $qry = "INSERT INTO category (title_category, content_category) VALUES (:title_category, :content_category)";
        $parm = array(
        ...
        <div class="container">
            <div class="modal__content">
                <form action="" method="post">
                    ...
                    <input required placeholder="Название" name="title_category" type="text" class="modal__input">
                    <textarea required placeholder="Текст" name="content_category" type="text" class="modal__area"></textarea>
